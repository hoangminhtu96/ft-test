...
contract Reward is Auth {
  ...
  function setTgeRatio(uint _tgeRatio) onlyMainAdmin external {
    tgeRatio = _tgeRatio;
  }

  function setSecondsInOneMonth(uint _secondsInOneMonth) onlyMainAdmin external {
    secondsInOneMonth = _secondsInOneMonth;
  }
